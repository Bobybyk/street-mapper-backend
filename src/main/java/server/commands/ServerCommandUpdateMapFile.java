...
public class ServerCommandUpdateMapFile implements ServerCommand {
    ...
    private static final String DESCRIPTION = "change la plan";

    private static final String FILE_ERROR = "Le ficher est un dossier ou inexistant";

    private static final String FILE_NOT_GIVEN =
            "s'attend à recevoir uniquement le chemin vers le nouveau fichier";
    ...
    public List<String> getExemples(String commandName) {
        return Arrays.asList(
                new StringBuilder().append(commandName).append(" <ficher du plan>").toString());
    }
